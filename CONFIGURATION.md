...
- [Configuration Variables](#configuration-variables)
  - [1. TF-M Configuration](#1-tf-m-trusted-firmware-m-configuration---boot-stage-1)
  - [2. TF-A Configuration](#2-tf-a-trusted-firmware-a-configuration---boot-stage-2)
  - [3. U-Boot Configuration](#3-u-boot-configuration---boot-stage-3)
  - [4. Kernel Configuration](#4-kernel-configuration---boot-stage-4)
  - [5. Init System Configuration](#5-init-system-configuration---boot-stage-5)
  - [6. User Account Configuration](#6-user-account-configuration---user-space-setup)
  - [7. Data Partition Configuration](#7-data-partition-configuration---storage-mount)
  - [8. Image Configuration](#8-image-configuration---build-output)
  - [9. Package Management](#9-package-management---build-system)
- [Configuration Examples](#configuration-examples)
  - [Example 1: Development Build](#example-1-development-build-default)
  - [Example 2: Production Build](#example-2-production-build-with-secure-keys)
  - [Example 3: KAS YAML Configuration](#example-3-kas-yaml-configuration)
